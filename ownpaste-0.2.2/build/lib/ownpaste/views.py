...
#
#I am starting my own edit here.
#

#Using "path:" here includes slashes for sub directories.
#Effectively, this is a naive static file website.
@views.route('/files/<path:filepath>')
def returnfile(filepath):
  ...
  try:
    ...
    asked_file = open(str('files/' + '404.html'), 'r')
  for line in asked_file:
    file_result+=line
  asked_file.close()
  #if filepath[len(filepath)-3:len(filepath)] == '.js':
    #response.headers['Content-Type'] = 'text/javascript'
  return file_result
  #return url_for('files', filename=filepath)
#
#I am ending my own edit here.
#
